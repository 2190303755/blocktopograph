...
public class OldWorldItemListActivity extends AppCompatActivity {
    ...
    private ActivityResultLauncher<Uri> selectWorld;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_worldlist);
        ...
        this.world = new ViewModelProvider(this).get(WorldModel.class);
        ...
        this.selectWorld = registerForActivityResult(new FolderSelector(), uri -> {
            if (uri != null) {
        ...
        worldItemAdapter = new WorldItemRecyclerViewAdapter(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_create: {
                this.startActivity(new Intent(this, WorldListActivity.class));
                return true;
            }
            case R.id.action_open: {
                this.selectWorld.launch(null);
                return true;
                /*
                if (worldItemAdapter.isDisabled()) {
                    Snackbar.make(getWindow().getDecorView(), R.string.no_read_write_access, Snackbar.LENGTH_SHORT).show();
                ...
                alert.setPositiveButton(R.string.open, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        if (errTitle != null) {
                            ...
                            try {
                                World world = new World(this, null, WorldItemListActivity.this);
...
//            }
    ...
    public static class WorldItemRecyclerViewAdapter extends RecyclerView.Adapter<WorldItemRecyclerViewAdapter.ViewHolder> {
        ...
        WorldItemRecyclerViewAdapter(OldWorldItemListActivity activity) {
        ...
        void loadWorldList() {
                    ...
                    file -> {
                        if (file.getName().startsWith("com.netease")) {
                            ...
                            if (worldsFolder.exists()) {
                                ...
                                marks.add(this.context.getString(R.string.world_mark_neteas));
                            }
                        }
                        return false;
                    }
            ...
            Collections.sort(mWorlds, (a, b) -> {
                try {
                    return Long.compare(a.data.getLastPlayedTimestamp(this.context), b.data.getLastPlayedTimestamp(this.context));
                } catch (Exception e) {
                    Log.d(this, e);
                    return 0;
                }
